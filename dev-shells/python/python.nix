...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    export LD_LIBRARY_PATH=${pkgs.libxkbcommon}/lib:${pkgs.wayland}/lib:${pkgs.glib.out}/lib:${pkgs.libGL.out}/lib:${pkgs.libGL}/lib:e${pkgs.eigen}/lib:${pkgs.zlib}/lib:${pkgs.gcc.cc.lib}/lib:${pkgs.stdenv.cc.cc.lib}/lib
